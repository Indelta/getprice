...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2016/10/9 00:00:00');
 var newDt = new Date();
  

    /* add 35 days to the current date */
    newDt.setDate(newDt.getDate() + 10);   

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',newDt,'<span class="number-wrapper"><div class="line"></div><span class="number end">Time is up!</span></span>');
 timer.countDown();
}
