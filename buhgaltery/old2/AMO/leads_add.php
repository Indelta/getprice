...
switch($sfera) {
    ...
    case "Строительство":
        $sfera_id = 288299;
        break;
    case "Несколько видов деятельности":
        $sfera_id = 1197661;
        break;
    case "Другая":
        $sfera_id = 292905;
...
switch($org_forma) {
    case "ООО (ОДО)":
        $org_forma_id = 1197665;
        break;
    case "ЧУП":
        $org_forma_id = 1197669;
        break;
    case "ОАО (АО, ЗАО)":
        $org_forma_id = 1197663;
        break;
    case "Иностранное предприятие или представительство":
        $org_forma_id = 1197667;
        break;
    default:
        $org_forma_id = 310041;
};
...
switch($nalog) {
    case "Упрощённая система налогообложения без НДС":
        $nalog_id = 309943;
        break;
    case "Упрощённая система налогообложения с НДС":
        $nalog_id = 309941;
        break;
    case "Общая система налогообложения":
        $nalog_id = 309939;
        break;
    default:
        $nalog_id = 309951;
